...
- [Banco de Dados e Migrations](#banco-de-dados-e-migrations)
  ...
  - [Configuração Flyway](#configuração-flyway)
- [Testes](#testes)
  - [Estrutura](#estrutura)
...
- [Resiliência](#resiliência)
  - [Dependência (Extension)](#dependência-extension)
  ...
  - [Integração com REST Client](#integração-com-rest-client)
  - [Métricas de Resiliência](#métricas-de-resiliência)
- [Segurança (AuthN/AuthZ)](#segurança-authnauthz)
  - [Dependências (Extensions)](#dependências-extensions)
  - [Organização de Pacotes](#organização-de-pacotes-1)
  - [Configuração (application.properties)](#configuração-applicationproperties-1)
  - [RBAC (Role-Based Access Control)](#rbac-role-based-access-control)
- [Tratamento Global de Erros](#tratamento-global-de-erros)
  - [Padrão: ProblemDetail (RFC 9457) via ExceptionMapper](#padrão-problemdetail-rfc-9457-via-exceptionmapper)
  - [Organização](#organização)
  - [Padrão de ExceptionMapper](#padrão-de-exceptionmapper)
...
- [Paginação e Ordenação](#paginação-e-ordenação)
  ...
  - [Padrão com Panache](#padrão-com-panache)
  - [Padrão no Service](#padrão-no-service)
  - [Record de Resposta Paginada](#record-de-resposta-paginada)
  - [Limites](#limites)
- [CORS](#cors)
  - [Configuração (application.properties)](#configuração-applicationproperties-2)
...
- [Virtual Threads](#virtual-threads)
  - [Configuração (Quarkus 3.x + JDK 25)](#configuração-quarkus-3x--jdk-25)
  - [Impacto](#impacto)
  - [Cuidados](#cuidados)
...
- **`@Transactional`** nos services: `@Transactional` em métodos de escrita, `@Transactional(TxType.SUPPORTS)` para leituras.
