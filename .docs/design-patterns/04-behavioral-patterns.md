...
> **Veja também:** [State](#state) (similar em estrutura), [Template Method](#template-method) (alternativa via herança), [Factory Method](02-creational-patterns.md#factory-method) (para criar a Strategy adequada), [OCP em SOLID](01-solid-principles.md#o--openclosed-principle-ocp)
...
> **Veja também:** [Mediator](#mediator) (centraliza comunicação), [Event-Driven Architecture](05-architectural-patterns.md#event-driven-architecture), [Command](#command)
...
> **Veja também:** [Memento](#memento) (para armazenar estado de undo), [Strategy](#strategy), [CQRS](05-architectural-patterns.md#cqrs--command-query-responsibility-segregation)
...
> **Veja também:** [Strategy](#strategy) (alternativa via composição), [Factory Method](02-creational-patterns.md#factory-method) (frequentemente usado junto), [Composição sobre Herança](06-best-practices.md#composição-sobre-herança)
...
> **Veja também:** [Strategy](#strategy) (similar em estrutura), [Singleton](02-creational-patterns.md#singleton) (states compartilhados como singletons)
...
> **Veja também:** [Decorator](03-structural-patterns.md#decorator) (similar em encadeamento), [Composite](03-structural-patterns.md#composite), [Command](#command)
...
> **Veja também:** [Observer](#observer) (alternativa descentralizada), [Facade](03-structural-patterns.md#facade) (simplificação unidirecional)
...
> **Veja também:** [Composite](03-structural-patterns.md#composite) (iteração sobre árvores), [Visitor](#visitor)
...
> **Veja também:** [Command](#command) (frequentemente usado junto para undo), [Event Sourcing](05-architectural-patterns.md#event-sourcing) (alternativa arquitetural para histórico)
...
> **Veja também:** [Composite](03-structural-patterns.md#composite) (Visitor é frequentemente usado sobre árvores Composite), [Iterator](#iterator), [Strategy](#strategy)
